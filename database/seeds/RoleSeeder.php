...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'cms.index'])->syncRoles([ $role_admin, $role_invent, $role_blog, $role_buyer]);
        // Rutas de Usuarios
        ...
        // Rutas de Ventas
        Permission::create(['name' => 'cms.orders.show']   )->syncRoles([ $role_admin, $role_invent ]);
        ...
        // Rutas de compras
        Permission::create(['name' => 'cms.purchases.show'])  ->syncRoles([ $role_buyer ]);
        Permission::create(['name' => 'cms.purchases.order']) ->syncRoles([ $role_buyer ]);
        Permission::create(['name' => 'cms.purchases.update'])->syncRoles([ $role_buyer ]);
