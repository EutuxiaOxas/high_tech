    ...
    <div class="col px-0">
        <div class="card">
            <div class="card-header row justify-content-between align-items-center mx-0">
                <h3 class="card-title col">Artículos creados</h3>
                <a class="btn btn-primary btn-sm ml-2 text-white" href="{{ route('cms.blog.create') }}">Crear Artículo</a>
                <div class="card-tools ml-auto">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endcan
                                @can('cms.blog.destroy')
                                <form class="d-inline mb-0" action="/cms/blog/eliminar/articulo/{{$articulo->id}}" method="POST">
                                    @csrf
                                    @method('DELETE')
