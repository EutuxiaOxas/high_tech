...
<section>
  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Crear parametro</h1>
  </div>
  ...
  <div class="">
      ...
      @endif
      <form action=" {{ route('cms.products.parameters.store') }} " method="POST" enctype="multipart/form-data" id="formSubmit">
        @csrf
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-6 mb-4">
            ...
            <input class="form-control" id="titulo_producto" type="text" maxlength="191" required name="parameter" >
          </div>
          ...
          <div class="row">
            <div class="col-12 mb-5">
                ...
                <input type="submit" class="btn btn-primary px-5" value="Crear parametro">
                @endcan
