                  ...
                  <div class="row gutter-1">
                      <div class="col text-center">
                        <a href="{{ route('products.category', 'automotriz') }}" aria-label="ver los productos de la categoria automotriz">
                            <img class="mb-1" src="/imagenes/banner_principal/01.webp" alt="imagen de la categoria automotriz | High Tech Bearings" loading="lazy">
                      ...
                      <div class="col text-center">
                        <a href="{{ route('products.category', 'industrial') }}" aria-label="ver los productos de la categoria industrial">
                            <img class="mb-1" src="/imagenes/banner_principal/02.webp" alt="imagen de la categoria industrial | High Tech Bearings" loading="lazy">
                      ...
                      <div class="col text-center">
                        <a href="{{ route('products.category', 'cadenas') }}" aria-label="ver los productos de la categoria cadenas">
                            <img class="mb-1" src="/imagenes/banner_principal/03.webp" alt="imagen de la categoria cadenas | High Tech Bearings" loading="lazy">
                      ...
                      <div class="col text-center">
                        <a href="{{ route('products.category', 'chumacera') }}" aria-label="ver los productos de la categoria chumacera">
                            <img class="mb-1" src="/imagenes/banner_principal/04.webp" alt="imagen de la categoria chumaceras | High Tech Bearings" loading="lazy">
