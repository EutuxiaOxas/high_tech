    ...
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-{{$headerLinks}}">
        ...
        <div class="navbar d-md-none">
            <button class="btn px-0 open_modal_shopping_car" data-toggle="modal" data-target="#modal_shopping_car" style="position:relative;" aria-label="ir al carrito de compras">
