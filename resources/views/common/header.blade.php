        ...
        <nav class="navbar navbar-expand-lg navbar-{{$headerLinks}}">
            ...
            <div class="navbar d-md-none">
                <button class="btn px-2 open_modal_shopping_car" data-toggle="modal" data-target="#modal_shopping_car" style="position:relative;" aria-label="ir al carrito de compras">
                    <svg class="navbar-logo-dark" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000">
                ...
                @if ( !isset($page) )
                    <ul class="navbar-nav align-items-center mr-0">
                        ...
                        <li class="ml-2 d-none d-lg-block">
                            <a class="nav-link open_modal_shopping_car navbar-brand align-middle my-0 mr-0 pt-1" style="position:relative;" href="#" aria-label="ir al carrito de compras" data-toggle="modal" data-target="#modal_shopping_car" aria-label="ir al carrito de compras">
                                <img class="navbar-logo navbar-logo-light" src="{{asset('svg/logo-car-'. $logoNav1 .'.svg')}}" alt="Logo High Tech" loading="lazy" width="24px" height="24px">
                                <img class="navbar-logo navbar-logo-dark" src="{{asset('svg/logo-car-'. $logoNav2 .'.svg')}}" alt="Logo High Tech" loading="lazy" width="24px" height="24px">
                                <span class="badge_shopping_car text-xs badge_products" style="display: none;"></span>
                            </a>
                        </li>
                    </ul>
