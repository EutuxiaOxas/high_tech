    ...
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-{{$headerLinks}}">
        <a class="navbar-brand" href="{{route('home')}}" aria-label="ir a la pagina de inicio del sitio web">
          <img class="navbar-logo navbar-logo-light" src="{{asset('svg/logo-'. $logoNav1 .'.svg')}}" alt="Logo High Tech" loading="lazy">
          <img class="navbar-logo navbar-logo-dark" src="{{asset('svg/logo-'. $logoNav2 .'.svg')}}" alt="Logo High Tech" loading="lazy">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center mr-0">
            ...
            <li class="ml-2">
                    <a class="nav-link open_modal_shopping_car" style="position:relative;" href="#" aria-label="ir al carrito de compras" data-toggle="modal" data-target="#modal_shopping_car">
